...
# 56 "watchdog_demo.c" 2


void __attribute__((picinterrupt(("")))) isr(void);

const char startingMsg[] = "Starting";
const char runningMsg[] = "Running ";
